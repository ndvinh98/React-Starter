      ...
      getItem(
        {
          ...
          relations: JSON.stringify([
            ...
            'fileTransfer.fileTransferAttachments',
          ]),
        },
        {path: params?.id},
      );
      ...
      <UI.Box minH="77vh" p={8}>
        ...
        <UI.Box mt={4} bg="white" shadow="sm" p={5}>
          <UI.VStack spacing="20px">
            ...
            <UI.HStack alignItems="flex-start" w="full">
              <UI.Text w="300px">Date received:</UI.Text>
              {data?.createdAt && (
                <UI.Text>
            ...
            <UI.HStack alignItems="flex-start" w="full">
              ...
              {!isEmpty(data?.fileTransfer.fileTransferAttachments) && (
                <UI.VStack alignItems="flex-start" w="calc(100% - 300px)">
                  {data?.fileTransfer?.fileTransferAttachments.map((x) => (
