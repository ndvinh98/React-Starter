...
function Edit() {
  ...
  useEffect(() => {
    if (params?.id)
      getItem({relations: JSON.stringify(['product'])}, {path: params?.id});
  }, [params]);

  const {patch, data, loading} = usePatch(`productModules/${moduleData?.id}`);
  ...
  return (
    <UI.Box py={5} px={7}>
      <LoadingComponent isLoading={loadingModule}>
        <UI.HStack
          w="full"
            ...
            <FormGenerate
              ...
              schema={{
                name: yup
                  ...
                  .default(moduleData?.name),
                mediaType: yup
                  .string()
                  .required('Media Type is required')
                  .default(moduleData?.mediaType),
              ...
              fields={[
                ...
                },
                {
                  ...
                  width: '70%',
                  defaultValue: {
                    value: moduleData?.mediaType,
                    label: moduleData?.mediaType,
                  },
                ...
                },
                {
                  ...
                  width: '70%',
                  // defaultValue: {
                  //   label: moduleData?.application?.name,
                  //   value: moduleData?.application?.id,
                  // },
