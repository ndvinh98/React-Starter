...
function ListViewMain(props: IListViewLayout) {
  const {
  ...
  return (
    <UI.VStack w={'full'}>
      <UI.Box w={'full'} overflow={'auto'} {...props} height={height}>
        {isLoading ? (
...
export default React.memo(ListViewMain);
